...
CFLAGS += -Os -std=gnu99 -Wall -nostdlib
...
all: stm32f429i-disco stm32429i-eval stm32f469i-disco stm32746g-eval stm32h743i-eval stm32h743i-atk
...
stm32h743i-atk: stm32h743i-atk.o $(obj-f7)
	$(LD) -T stm32h743.lds $(LINKERFLAGS) -o stm32h743i-atk.elf stm32h743i-atk.o $(obj-f7)
	$(OBJCOPY) -Obinary stm32h743i-atk.elf stm32h743i-atk.bin
	$(SIZE) stm32h743i-atk.elf
